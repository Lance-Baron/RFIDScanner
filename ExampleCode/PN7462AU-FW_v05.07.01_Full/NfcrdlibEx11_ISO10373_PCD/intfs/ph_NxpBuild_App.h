...
/* This Macro should be enabled when testing with FW version 3.6 and below  */
#ifdef NXPBUILD__PHHAL_HW_PN5180
    //#define PN5180_HAL_DIGITAL_DELAY                      /**< Enable to disable FW digital and use HAL digital delay. */
