...
==============================================
  ...
  the compliance to the ISO 14443 protocols.  An external tool like Micropross
  MP300 implements the testmethods for the ISO 10373-6 and is used as the
  counterpart for this testing.
...
===========================================
  ...
  - To execute the ISO PCD test bench using the configurations provided,
    Micropross MP300 TCL2 tool with ISO 10373-6 PCD test suite is required.
  ...
  - This software project requires NxpNfcRdLib v05.07.00 or later.
...
=============================================
  ...
  - This example can be used for running ISO 10373-6 PCD test suite.
  - This example has been verified using the MP300 Test Tool. To run with PCD
    test suite, load the Micropross test bench configuration file
